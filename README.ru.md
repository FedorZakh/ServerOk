...
| **Network Speedtest** | Upload, download и задержка — либо до узлов speedtest.net (по всему миру или по одному региону: Европа, Северная Америка, Азия), либо до ближайшего edge-узла Cloudflare. Серверы Ookla ищутся по названию города, поэтому нерабочие спонсоры пропускаются автоматически |
